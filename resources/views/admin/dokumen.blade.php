                       ...
                       <div class="text-center">
                           ...
                           <p class="mb-3 text-sm">Lembaga Belum Menyelesaikan Dokumen yang Anda Kirimkan. Hubungi Admin Lembaga Untuk Informasi Lebih Lanjut.</p>
                            <div class="col-12 mt-4">
                                <button type="button" data-dismiss="modal" aria-label="Close" class="btn btn-primary btn-block">Oke, Saya Mengerti</button>
                            </div>
        ...
        $('#dokumenTable').DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                            <i class="far fa-trash-alt ms-2 text-danger cursor-pointer" data-toggle="modal" data-target="#hapusModalCenter${row.id}" title="Hapus Data"></i>`;
                    },
    ...
    $(document).ready(function() {
        var table = $('#historyTable').DataTable({
            ...
            columns: [
                ...
                { data: 'dokumen', name: 'dokumen', width: "20px", },
