...
<div class="container-fluid">
    <div class="page-header min-height-300 border-radius-xl mt-4"
        style="background-image: url('{{ asset('creative') }}/assets/img/curved-images/curved0.jpg'); background-position-y: 50%;">
            ...
            <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                <div class="nav-wrapper position-relative end-0">
                    <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist" id="pills-tab">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link mb-0 px-0 py-1" id="pills-score-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-score" type="button" role="tab" aria-controls="pills-score"
                                aria-selected="false">
                                <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <title>document</title>
                ...
                <div class="page-body">
                    <div class="row">
                        <div class="col-lg-12 d-flex flex-column justify-content-center text-center">
                            <div class="empty">
                                <div class="img-fluid"><img src="{{ asset('creative') }}/assets/img/empty.png"
                                        alt="RTM Kosong" width="300px"></div>
            ...
            $(document).ready(function() {
                $('#history-temuan-table').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'status_docs', name: 'status_docs' },
                ...
                <div class="page-body">
                    <div class="row">
                        <div class="col-lg-12 d-flex flex-column justify-content-center text-center">
                            <div class="empty">
                                <div class="img-fluid"><img src="{{ asset('creative') }}/assets/img/empty.png"
                                        alt="Tidak Ada Skor" width="300px"></div>
                                                        ...
                                                        <div class="d-flex px-2 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-sm">
                                                                    {{ $item->lembaga->nama_lembaga }}</h6>
                                                                <p class="text-xs text-secondary mb-0">
                                                                    {{ $item->lembaga->user->name }}</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex flex-column justify-content-center ms-4">
                                                            <p
                                                                class="text-xs text-dark font-weight-bold text-secondary mb-0">
                                                                {{ $item->total_temuan }} Temuan</p>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex flex-column justify-content-center me-5">
                                                            <p
                                                                class="text-lg text-dark font-weight-bold text- ms-4 mb-0">
                                                                {{ $item->total_score }}</p>
                                                        </div>
                                                    </td>
                                                </tr>
                        ...
                        <ul>
                            <h6 class="text-sm py-3">
                                <li>Dibuat :
                                    ...
                                    {{ \Carbon\Carbon::parse($item->created_at)->format('H:i') }}</li> <br>
                                ...
                                <li>Deadline Pengerjaan :
                                    {{ \Carbon\Carbon::parse($item->deadline)->locale('id')->translatedFormat('l, d F Y') }}
                                </li> <br>
                                <li>Diselesaikan oleh lembaga :
                                    {{ \Carbon\Carbon::parse($item->tgl_pengumpulan)->locale('id')->translatedFormat('l, d F Y') }}
                                </li> <br>
                                <li>Status Pengisian :
...
{{-- {{-- Modal Hapus Riwayat --}}
@foreach ($riwayat as $item)
    <div class="modal fade" id="hapusModalCenter{{ $item->id }}" tabindex="-1" role="dialog"
                ...
                <div class="modal-body bg-3">
                    ...
                    <div class="p-4 to-front">
                        <div class="text-center">
                            <div class="logo">
                                <img src="{{ asset('creative') }}/assets/img/hapus-docs.jpg" alt="img-fluid"
                                    class="img-fluid mb-4 w-60">
                            </div>
                            <h4>Hapus Temuan Audit</h4>
                            <p class="mb-3 text-sm">Tindakan ini akan menghapus Temuan Audit <b>
                                    "{{ $item->temuan }}"</b> secara permanen.</p>
                            ...
                            <small class="mb-0 cancel"><small><i>Sistem Penjaminan Mutu Internal Kalla
                                        Institute</i></small></small>
                        </div>
                    </div>
                </div>
            </div>
...
@foreach ($evaluasi as $item)
    <div class="modal fade" id="editModalCenter{{ $item->id }}" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content rounded-0">
                <div class="modal-body bg-3">
                    ...
                    <div class="p-4 to-front">
                        <div class="text-center">
                            <div class="logo">
                                <img src="{{ asset('creative') }}/assets/img/send-docs.jpg" alt="img-fluid"
                                    class="img-fluid mb-4 w-60">
                            </div>
                            <h4>Edit Status Dokumen</h4>
                            <p class="mb-3 text-sm">Lembaga telah melakukan pengisian kelengkapan dokumen yang telah
                                Anda berikan pada tanggal :
                                <b>{{ \Carbon\Carbon::parse($item->tgl_pengumpulan)->locale('id')->translatedFormat('l, d F Y') }}</b>
                            </p>
                            <form action="/editTemuan/{{ $item->id }}" class="mb-4" method="POST">
                                ...
                                <div class="deadline-form" id="Score-form{{ $item->id }}"
                                    style="display: none;">
                                    <div class="form-group">
                                        <label for="score">Score</label>
                                        <input type="number" class="form-control" id="score{{ $item->id }}"
                                            name="score" placeholder="0 - 276">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 mt-4">
                                    ...
                                    <div class="col-6 mt-4">
                                        <input type="hidden" name="hidden_score" value="4"
                                            id="hiddenScore{{ $item->id }}">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        statusSelects.forEach((statusSelect, index) => {
            ...
            const hiddenScore = document.getElementById('hiddenScore' + statusSelect.id.replace(
                'statusSelect', ''));
...
@foreach ($evaluasi as $item)
    <div class="modal fade" id="unsend{{ $item->id }}" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content rounded-0">
                <div class="modal-body bg-3">
                    ...
                    <div class="p-4 to-front">
                        <div class="text-center">
                            <div class="logo">
                                <img src="{{ asset('creative') }}/assets/img/unsend.png" alt="img-fluid"
                                    class="img-fluid mb-4 w-60">
                            </div>
                            <h4>Lembaga Belum Menyelesaikan Dokumen</h4>
                            <p class="mb-3 text-sm">Lembaga Belum Menyelesaikan Dokumen yang Anda Kirimkan. Hubungi
                                Admin Lembaga Untuk Informasi Lebih Lanjut.</p>
                            <div class="col-12 mt-4">
                                <button type="button" aria-label="Close" data-dismiss="modal"
                                    class="btn btn-primary btn-block">Oke, Saya Mengerti</button>
                            </div>
                            <small class="mb-0 cancel text-center"><small><i>Sistem Penjaminan Mutu Internal Kalla
                                        Institute</i></small></small>
                        </div>
                    </div>
                </div>
